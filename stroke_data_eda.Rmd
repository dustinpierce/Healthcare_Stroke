...
```{r data, include=FALSE, fig.cap="A caption", out.width = '100%'}
...
```{r understand_data, include=FALSE, fig.cap="A caption", out.width = '100%'}
...
```{r feature_engineering, include=FALSE, fig.cap="A caption", out.width = '100%'}
...
```{r stroke_cases, include=FALSE, fig.cap="A caption", out.width = '100%'}
...
```{r class_balance, include=FALSE, fig.cap="A caption", out.width = '100%'}
...
```{r pca, include=FALSE, fig.cap="A caption", out.width = '100%'}
...
```{r partition, include=FALSE, fig.cap="A caption", out.width = '100%'}
# set seed
set.seed(13) 
...
```{r logsitic, include=FALSE, fig.cap="A caption", out.width = '100%'}
## Logistic regression
...
In this subsection, we train a neural network using the `neuralnet` package. We experimented with a variety of activiation functions, learning algorthims and neural network architectures. Ultimately, we decided to use 1 hidden layer with 2 neurons, binary cross entropy as the error function, sigmoid activation function and resilient backpropagation without backtracking algorithm. 

We calculate the class probabilities together with the class predictions and assess performance via the so-called `confusion matrix`.

```{r nn, include=FALSE, fig.cap="A caption", out.width = '100%'}
## NN
#####################################################
...
nn <- neuralnet::neuralnet(formula = formula_linear, data = train, 
                           ...
                           threshold = 0.5, hidden = 2, startweights = NULL, 
...
```{r rf, include=FALSE, fig.cap="A caption", out.width = '100%'}
# Random forest
...
```{r vote, include=FALSE, fig.cap="A caption", out.width = '100%'}
## Voting classifier
...
```{r validation, include=FALSE, fig.cap="A caption", out.width = '100%'}
